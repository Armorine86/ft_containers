...
/*   Updated: 2022/06/06 22:12:59 by mmondell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class const_tree_iterator {
  ...
  public:
    ...
    bool operator==(const const_tree_iterator& rhs) const { return ptr == rhs.ptr; }
    bool operator==(const non_const_iterator& rhs) const { return ptr == rhs.base(); }

    bool operator!=(const const_tree_iterator& rhs) const { return !(*this == rhs); }
    bool operator!=(const non_const_iterator& rhs) const { return !(*this == rhs); }
