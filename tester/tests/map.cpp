...
/*   Updated: 2022/06/27 21:29:01 by mmondell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    //     std::cout << "*** line: " << __LINE__ << " ***\n" <<  "The allocated array has a size of
    //     " << psize << " bytes." << std::endl;
    ...
    // 			std::cout << "*** line: " << __LINE__ << " ***\n" << "end of equal_range (p.second) is
    // one-past p.first\n\n"; 		else
    //         	std::cout << "*** line: " << __LINE__ << " ***\n" << "unexpected; p.second expected
    //         to be one-past p.first\n\n";

    // 		p = m.equal_range(-1);

    // 		if (p.second == m.begin())
    //         	std::cout << "*** line: " << __LINE__ << " ***\n" << "p.second is iterator to first
